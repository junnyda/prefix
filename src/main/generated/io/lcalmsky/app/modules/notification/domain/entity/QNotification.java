...
public class QNotification extends EntityPathBase<Notification> {
    ...
    public final io.lcalmsky.app.modules.account.domain.entity.QAccount account;
    ...
    public QNotification(Class<? extends Notification> type, PathMetadata metadata, PathInits inits) {
        ...
        this.account = inits.isInitialized("account") ? new io.lcalmsky.app.modules.account.domain.entity.QAccount(forProperty("account"), inits.get("account")) : null;
    }
